...
class ApiTests(BaseTestCase):
    ...
    def test_get_repositories(self):
        response = self.client.get(reverse('api_get_repositories'), {})
    ...
    def test_get_environment(self):
        response = self.client.get(reverse('api_get_environment', kwargs={'environment_id': 1}))
        data = self._verify_response(response)
    ...
    def test_create_environment(self):
        ...
        response = self.client.post(reverse('api_create_environment'), kwargs)
        data = self._verify_response(response, kwargs)
    ...
    def test_get_environment_stages(self):
        response = self.client.get(reverse('api_get_environment_stages', kwargs={'environment_id': 1}))
        data = self._verify_response(response)
    ...
    def test_get_environment_stage(self):
        response = self.client.get(reverse('api_get_environment_stage', kwargs={'environment_id': 1, 'stage_id': 1}))
        data = self._verify_response(response)
    ...
    def test_create_environment_stage(self):
        ...
        response = self.client.post(reverse('api_create_environment_stage', kwargs={'environment_id': 1}), create_args)
        data = self._verify_response(response)
    ...
    def test_get_deployments(self):
        response = self.client.get(reverse('api_get_deployments'), {})
        data = self._verify_response(response)
